/**
  ...
  */
package com.example.xinhuayipin.data.borrow;

/**
 * Auto-generated: 2019-09-03 14:6:58
 *
 * @author bejson.com (i@bejson.com)
 * @website http://www.bejson.com/java2pojo/
 */
public class Marc_info {
        ...
        private String year_times;
        private String marc_data;
        private int status;
        private String opac_flag;
        private String operator_id;
        private String operator_name;
        private String create_time;
        private String update_time;
        private int marc_book;
        ...
        public void setYear_times(String year_times) {
            this.year_times = year_times;
        }
        public String getYear_times() {
            return year_times;
        }

        public void setMarc_data(String marc_data) {
            this.marc_data = marc_data;
        }
        public String getMarc_data() {
            return marc_data;
        }
        ...
        public void setMarc_book(int marc_book) {
                this.marc_book = marc_book;
            }
            public int getMarc_book() {
                return marc_book;
            }
