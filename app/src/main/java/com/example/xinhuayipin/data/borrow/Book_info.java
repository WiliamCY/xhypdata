...
public class Book_info {
        ...
        private int lend_flag;
        private long in_date;
        private int year_times;
        ...
        public void setLend_flag(int lend_flag) {
            this.lend_flag = lend_flag;
        }
        public int getLend_flag() {
            return lend_flag;
        }
        ...
        public void setYear_times(int year_times) {
            this.year_times = year_times;
        }
        public int getYear_times() {
            return year_times;
        }
        ...
        public void setFirst_use_time(long first_use_time) {
        ...
        public void setBookcase_id(String bookcase_id) {
