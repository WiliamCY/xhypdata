...
public class DataTimeUtil {
    ...
    /** Log输出标识 **/
    private static final String TAG = DataTimeUtil.class.getSimpleName();
    ...
    public static String formatDateTime(long dateL) {
        Log.i(TAG, "formatDateTime: "+dateL);
        if (dateL < 10000000000L) {
            dateL = dateL * 1000;
        }
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(DF_YYYY_MM_DD_HH_MM_SS);
        Date date = new Date(Long.parseLong(String.valueOf(dateL)));
    ...
    public static boolean compareDate(Date target1, Date target2) {
        boolean flag = false;
        try {
            String target1DateTime = DataTimeUtil.formatDateTime(target1,
                    DF_YYYY_MM_DD_HH_MM_SS);
            String target2DateTime = DataTimeUtil.formatDateTime(target2,
                    DF_YYYY_MM_DD_HH_MM_SS);
