package com.example.commons.view.tick;
...
import com.example.commons.utils.DisplayUtil;
...
public class TickView extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mConfig.setUnCheckBaseColor(typedArray.getColor(R.styleable.TickView_uncheck_base_color, getResources().getColor(R.color.tick_gray)))
                ...
                .setTickRadiusOffset(typedArray.getDimensionPixelOffset(R.styleable.TickView_tick_radius_set, dp2px(4)));
    ...
    private void initAnimatorCounter() {
        ...
        if (mConfig.getTickAnim() == TickViewConfig.ANIM_ALPHA) {
            ...
            ((ValueAnimator) mTickAnima).addUpdateListener(animation -> setTickProgress((Float) animation.getAnimatedValue()));
